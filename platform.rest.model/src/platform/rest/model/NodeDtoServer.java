...
public class NodeDtoServer
    ...
    public void delete(final String id) {
        ...
        while (true) {
            final IRelation relation = NodeUtils.findParentRelation(this.nodeMapper.getRoot(), new TraversalContext(), id);
            if (relation == null) {
                return;
            }
    ...
    public void merge(final NodeDto entity) {
        ...
        if (current != null) {
            NodeUtils.merge(current, new TraversalContext(), node);
        } else {
